...
int AAPIInit()
{
	...
	//Retrieve network info path
	//bool* nonConvertChars = new bool();
	//const char* networkPathASCII = AKIConvertToAsciiString( AKIInfNetGetNetworkPath(),true,nonConvertChars );
	//string networkPathString = networkPathASCII;
	//string inputFolder = networkPathString+"/projects/";
	//delete nonConvertChars;

	//SUGESTION 1
	//ecodrive.open(inputFolder+"eco-driving_powertrainOpt/ecodrive.txt");
	...
	//SUGESTION 2
	//sigopt.open(inputFolder+"eco-driving_powertrainOpt/sigopt.txt");
	...
	//SUGESTION 3
	//string outputFolder = networkPathString+"/results/";
	//string main_output_path = outputFolder;
	string main_output_path = "D:\\results\\";
	string output_path = main_output_path+ control_method + "_" + "demand" + to_string(demand_percentage) + "_" + "CAV" +
